...
- [x] 1.1 Install infra-terraform.feature + ci-cd.feature into tests/features/ (all scenarios @manual — verified by the drills below); confirm suite still green
...
- [x] 2.1 Test setup-turso script dry-run/shape (unit test the script's output contract where feasible) — confirm red
...
- [x] 3.1 Static tests for workflow files (actionlint or schema-level assertions: deploy ordering, PR checks present, backup cron) — confirm red
