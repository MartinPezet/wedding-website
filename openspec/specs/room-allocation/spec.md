# room-allocation Specification

## Purpose
Manual pairing of "match us with another guest" room requests, the combined rooming picture across both nights, and the rooming list in the venue export. Created by archiving change add-payment-and-room-allocation.
